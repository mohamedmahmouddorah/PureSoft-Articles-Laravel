        ...
        <form action="{{ route('articles.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <input type="number" step="0.01" class="form-control" name="price" placeholder="Price ($)" value="{{ old('price') }}" required>
                </div>
                <div class="col-md-6 mb-3">
                    <input type="number" class="form-control" name="stock" placeholder="Stock Quantity" value="{{ old('stock') }}" required>
                </div>
            </div>
